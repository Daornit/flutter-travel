...
final List<Entry> entries = <Entry>[
  Entry(
    ...
    <Entry>[
      Entry(
        'Гал түймэртэй тэмцэх газар: 101',
      ),
      Entry(
        'Цагдаагийн газар: 102',
      ),
      Entry(
        'Нийслэлийн яаралтай тусламжийн төв: 103, 70120103',
      ),
      Entry(
        'Гамшиг ослын дуудлага: 105',
      ),
      Entry(
        'Гоц халдвартын түргэн: 100',
      ),
      Entry(
        'Хүүхдийн түргэн тусламж: 108',
      ),
      Entry(
        'Хувийн түргэн: 1971',
      ),
      Entry(
        'Халдвартын түргэн: 100',
      ),
      Entry(
        'Түлэнхий төв: 70135032',
      ),
      Entry(
        'Хордлогын үндэсний төв: 450097',
      ),
      Entry(
        'Эх нялхсын эрдэм шинжилгээний төв: 322633, 362644, 362648',
      ),
      Entry(
        'Сэтгэцийн эрүүл мэндийн төв: 70150513, 1800-2000',
      ),
      Entry(
        'Зэвсэгт хүчний клиникийн төв госпиталь: 453279',
      ),
      Entry(
        'Төмөр замын нэгдсэн эмнэлэг: 244969, 244951',
      ),
      Entry(
        'Гэмтэл согог судлалын үндэсний төв: 70180130, 70180131, 70180132',
      ),
      Entry(
        'Халдварт өвчин судлалын үндэсний төв: 80086829',
      ),
      Entry(
        'Цусны төв: 312857, 326504',
      ),
      Entry(
        'Нийслэлийн онцгой байдлын ерөнхий газар: 325726, 265726',
      ),
      Entry(
        'Нийслэлийн шуурхай штаб: 324207',
      ),
      Entry(
        'Эрүүл мэндийн яам: 323002',
      ),
      Entry(
        'Замын цагдаагийн жижүүр: 70112100',
      ),
      Entry(
        'Төмөр замын цагдаа: 24102',
      ),
    ],
  ),
  Entry(
    ...
    <Entry>[
      Entry(
        'Архангай аймгийн эрүүл мэндийн газар: 70332973',
      ),
      Entry(
        'Баян-Өлгий аймгийн эрүүл мэндийн газар: 70424299',
      ),
      Entry(
        'Баянхонгор аймгийн эрүүл мэндийн газар: 70440006, 70442878',
      ),
      Entry(
        'Булган аймгийн эрүүл мэндийн газар: 70343228',
      ),
      Entry(
        'Говь-Алтай аймгийн эрүүл мэндийн газар: 70484067, 70483066',
      ),
      Entry(
        'Говь-сүмбэр аймгийн эрүүл мэндийн газар: 70543021',
      ),
      Entry(
        'Дархан-Уул аймгийн эрүүл мэндийн газар: 70374157',
      ),
      Entry(
        'Дорноговь аймгийн эрүүл мэндийн газар: 86868875',
      ),
      Entry(
        'Дорнод аймгийн эрүүл мэндийн газар: 70583355, 91950355',
      ),
      Entry(
        'Дундговь аймгийн эрүүл мэндийн газар: 70593951',
      ),
      Entry(
        'Завхан аймгийн эрүүл мэндийн газар: 70462146',
      ),
      Entry(
        'Орхон аймгийн эрүүл мэндийн газар: 70355212',
      ),
      Entry(
        'Өвөрхангай аймгийн эрүүл мэндийн газар: 70323536, 94997721',
      ),
      Entry(
        'Өмнөговь аймгийн эрүүл мэндийн газар: 88532103',
      ),
      Entry(
        'Сүхбаатар аймгийн эрүүл мэндийн газар: 70518003',
      ),
      Entry(
        'Сэлэнгэ аймгийн эрүүл мэндийн газар: 70363588',
      ),
      Entry(
        'Төв аймгийн эрүүл мэндийн газар: 70272225',
      ),
      Entry(
        'Увс аймгийн эрүүл мэндийн газар: 70453149',
      ),
      Entry(
        'Ховд аймгийн эрүүл мэндийн газар: 70432526',
      ),
      Entry(
        'Хөвсгөл аймгийн эрүүл мэндийн газар: 70384005, 70383334',
      ),
      Entry(
        'Хэнтий аймгийн эрүүл мэндийн газар: 70562906',
      ),
    ],
  ),
  Entry(
    ...
    <Entry>[
      ...
      Entry(
        'Багануур дүүргийн онцгой байдлын хэлтэс: 7021-101, 7021-0301, 88286101',
      ),
      Entry(
        'Багахангай дүүргийн онцгой байдлын хэлтэс: 7049-101, 70491042',
      ),
      Entry(
        'Налайх дүүргийн онцгой байдлын хэлтэс: 7023-101, 89322101, 98322101',
      ),
      Entry(
        'Архангай аймгийн онцгой байдлын шуурхай хэлтэс: 7033-101, 7033-105, 7033-101 7033-2772',
      ),
      Entry(
        'Баян-өлгий аймгийн онцгой байдлын газар: 7042-101, 7042-105, 80105031',
      ),
      Entry(
        'Баянхонгор аймгийн онцгой байдлын газар: 7044-101',
      ),
      Entry(
        'Булган аймгийн онцгой байдлын газар: 7034-101',
      ),
      Entry(
        'Говь-алтай аймгийн онцгой байдлын газар: 7748-101, 7048-101, 7048-105',
      ),
      Entry(
        'Говь-сүмбэр аймгийн онцгой байдлын газар: 7054-101, 70543025, 98663501, 96540105',
      ),
      Entry(
        'Дархан-уул аймгийн онцгой байдлын газар: 7037-101, 7037-105',
      ),
      Entry(
        'Дорноговь аймгийн онцгой байдлын газар: 7052-101, 96520105, 86330105 70522301',
      ),
      Entry(
        'Дорноговь аймгийн Замын-үүд дахь сумын онцгой байдлын газар: 70527-101',
      ),
      Entry(
        'Дорнод аймгийн онцгой байдлын газар: 7058-101, 70584142, 96580105, 89303101',
      ),
      Entry(
        'Дундговь аймгийн онцгой байдлын газар: 7059-101, 7059-105, 7059-3030',
      ),
      Entry(
        'Завхан аймгийн онцгой байдлын газар: 7046-101, 7046-105',
      ),
      Entry(
        'Завхан аймгийн Тосонцэнгэл сум дахь онцгой байдлын хэлтэс: 7046-8101, 70468055',
      ),
      Entry(
        'Орхон аймгийн онцгой байдлын газар: 7035-101',
      ),
      Entry(
        'Өмнөговь аймгийн онцгой байдлын газар: 7053-101',
      ),
      Entry(
        'Өмнөговь аймгийн Ханбогд сумын онцгой байдлын газар: 88990105',
      ),
      Entry(
        'Өвөрхангай аймгийн онцгой байдлын газар: 7032-101',
      ),
      Entry(
        'Өвөрхангай аймгийн Хар хорин сумын онцгой байдлын газар: 7032-7101',
      ),
      Entry(
        'Сүхбаатар аймгийн онцгой байдлын газар: 7051-101',
      ),
      Entry(
        'Сэлэнгэ аймгийн онцгой байдлын газар: 7036-101, 7036-105, 70362255',
      ),
      Entry(
      ...
      Entry(
        'Увс аймгийн онцгой байдлын газар: 7045-101, 7045-105',
      ),
      Entry(
        'Ховд аймгийн онцгой байдлын газар: 7043-101, 7043-105',
      ),
      Entry(
        'Ховд аймгийн Булган сумын онцгой байдлын газар: 94386211',
      ),
      Entry(
        'Хөвсгөл аймгийн онцгой байдлын газар: 7038-101, 70382750',
      ),
      Entry(
        'Хэнтий аймгийн онцгой байдлын газар: 7056-101, 70563024, 70562111',
      ),
      Entry(
